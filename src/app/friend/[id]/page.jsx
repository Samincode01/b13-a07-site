...
import getFriends from "@/components/utils/getFriends";
      ...
      <div className="lg:col-span-2">
        ...
        <div className="p-4 sm:p-6 shadow-sm bg-white rounded-xl mt-5 flex flex-col min-[400px]:flex-row justify-between gap-5">
          ...
          <div className="space-y-7">
            <h2 className="text-[#2d4a43] font-bold text-center min-[400px]:text-start">
              Relationship Goal
            </h2>
        ...
        <div className="space-y-4 mt-6 p-5 shadow-sm bg-white rounded-2xl">
          ...
          <h2 className="text-[#2d4a43] font-bold text-lg">
            Quick Check-In
          </h2>
